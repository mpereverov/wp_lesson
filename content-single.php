...
$review_country = get_post_meta($post->ID, 'review_country', true);
$review_director = get_post_meta($post->ID, 'review_director', true);
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="container">
		<div class="row">
			<div class="review_inf col-md-12"><span><?php echo "Страна: $review_country" ?></span></div>
			<div class="review_inf col-md-12"><span><?php echo "Режисер: $review_director" ?><span></div>
			<div class="review_inf col-md-12"><span><?php echo "Год выпуска: $review_date" ?><span></div>
		</div>
	</div>
		<?php
	
		//Вывод таксономии
		 the_terms( $post->ID, 'genre', 'Жанры: ', ', ', ' ' ); 
		 ?>
